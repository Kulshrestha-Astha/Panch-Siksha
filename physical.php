...
<!-- physical section starts -->
<section class="physicall">
   <div class="box-container">
      <div class="box">
          ...
          <div class="content">
            <h3>Basket-Ball</h3>
            <p>Dribble,Shoot,Score!The battle on the court Begins!</p>
      ...
      <div class="box">
            ...
            <div class="content">
                <h3>Swimming</h3>
                <p>Swim like a Fish,Glide like a Champion</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Yoga</h3>
                <p>Find your Balance,Embrace Inner Peace:The Art of Yoga</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Horse riding</h3>
                <p>Unleash the Equestrian Spirit: Gallop towards Victory!</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Badminton</h3>
                <p>Feathers Fly, Rackets Clash: Badminton's Intense Battle for Glory!</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Shooting</h3>
                <p>Aim, Fire, Bullseye! Precision and Focus in the Shooting Arena!</p>
                <a href="enroll.php" class="btn">enroll now</a>
