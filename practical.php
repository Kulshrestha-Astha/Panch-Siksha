...
<section class="practicall">
   <div class="box-container">
      <div class="box">
          ...
          <div class="content">
            <h3>Printing n dying</h3>
            <p>Unleash your creativity with vibrant prints and dyes!</p>
      ...
      <div class="box">
            ...
            <div class="content">
                <h3>Batique</h3>
                <p>Unleash the beauty of Batik: A timeless art of intricate designs.</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Bandhej</h3>
                <p>Bandhej: The art of vibrant tie-dye that weaves stories.</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Tailoring</h3>
                <p>Tailoring: Where fabric meets craftsmanship for a perfect fit.</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>embroidery</h3>
                <p>Embroidery: The art of thread, needle, and creative expression</p>
                <a href="enroll.php" class="btn">enroll now</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>craft</h3>
                <p>Crafting: Unleash your imagination and create something extraordinary.</p>
                <a href="enroll.php" class="btn">enroll now</a>
